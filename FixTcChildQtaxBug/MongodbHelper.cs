...
namespace FixTcChildQtaxBug
{
    public class MongodbHelper
    {
        ...
        public static readonly string ConnectString = System.Configuration.ConfigurationManager.ConnectionStrings["MongoTkt"].ConnectionString;
    ...
    public class MongodbParameter
    {
        ...
        public MongodbParameter(string inputKey, object inputValue) {
            this.key = inputKey;
            this.value = inputValue;
        }

        public static MongodbParameter create(string inputKey, object inputValue)
        {
            return new MongodbParameter(inputKey, inputValue);
        }
    }
}
